///<summary>
///Класс который отвечает за аккаунт пользователя для сетевой игры
///</summary>
public class Account
{
  ///<summary>
  ///Индетефикационный номер пользователя
  ///</summary>
  private int userid;
  ///<summary>
  ///Имя пользователя
  ...
  ///<summary>
  ///Конструктор класса для создания аккаунта пользователя
  ///</summary>
  public Account(){
