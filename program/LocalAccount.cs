///<summary>
///Класс который отвечает за локальный аккаунт пользователя и его данные
///</summary>
public class LocalAccount //Класс содержащий локальные данные игрока (для одичной игры)
{
  ///<summary>
